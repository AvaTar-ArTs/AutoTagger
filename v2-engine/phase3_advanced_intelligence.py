...
def main():
    ...
    parser.add_argument('--input', default='~/AutoTagger/v2-engine/automations_index_phase2.json',
                        help='Input file from Phase 2')
    parser.add_argument('--output', default='~/AutoTagger/v2-engine/automations_index_phase3.json',
