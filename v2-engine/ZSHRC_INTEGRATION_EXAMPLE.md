...
scan-and-import() {
    ...
    if [ -f "$temp_csv" ]; then
        python3 ~/AutoTagger/v2-engine/csv_import_export.py import --csv-path "$temp_csv"
        rm "$temp_csv"
...
python3 ~/AutoTagger/v2-engine/csv_import_export.py import --csv-path automations_scan.csv
```
