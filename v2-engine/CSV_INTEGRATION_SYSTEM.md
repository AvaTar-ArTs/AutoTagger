...
python3 ~/AutoTagger/v2-engine/csv_import_export.py export --csv-path all_data.csv

# Export specific category
python3 ~/AutoTagger/v2-engine/csv_import_export.py export --csv-path ai_tools.csv --category "AI/Automation"
```

### Create Sample Data
```bash
# Generate sample CSV in the expected format
python3 ~/AutoTagger/v2-engine/csv_import_export.py sample
```
...
python3 ~/AutoTagger/v2-engine/csv_import_export.py import --csv-path /tmp/scan_output.csv
```
...
```bash
# Sync every hour
0 * * * * scan ~/AVATARARTS/Automations && python3 ~/AutoTagger/v2-engine/csv_import_export.py import --csv-path /tmp/scan_output.csv
```
