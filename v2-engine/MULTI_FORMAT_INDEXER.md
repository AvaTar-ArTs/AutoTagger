...
python3 ~/AutoTagger/v2-engine/multi_format_directory_indexer.py <directory>

# With custom prefix
python3 ~/AutoTagger/v2-engine/multi_format_directory_indexer.py <directory> <prefix>

# With specific format
python3 ~/AutoTagger/v2-engine/multi_format_directory_indexer.py <directory> <prefix> <format>

# With multiple formats
python3 ~/AutoTagger/v2-engine/multi_format_directory_indexer.py <directory> <prefix> "format1,format2,format3"

# Examples
python3 ~/AutoTagger/v2-engine/multi_format_directory_indexer.py ~/Pictures pictures_scan csv
python3 ~/AutoTagger/v2-engine/multi_format_directory_indexer.py ~/Documents docs_scan "csv,md"
python3 ~/AutoTagger/v2-engine/multi_format_directory_indexer.py ~/AVATARARTS/Automations automations_scan "json,csv,md,html"
```
