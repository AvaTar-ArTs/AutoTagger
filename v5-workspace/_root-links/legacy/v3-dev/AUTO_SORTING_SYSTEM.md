...
# Auto-sort with custom title
python3 ~/AutoTagger/v3-dev/auto_sorter.py --title "My Title" --verbose

# Force a specific category
python3 ~/AutoTagger/v3-dev/auto_sorter.py --force-category "Code/Scripts" --title "My Title" --verbose
```
