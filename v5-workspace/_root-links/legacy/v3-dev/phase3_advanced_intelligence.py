...
def main():
    ...
    parser.add_argument('--input', default='~/AutoTagger/v3-dev/automations_index_phase2.json',
                        help='Input file from Phase 2')
    parser.add_argument('--output', default='~/AutoTagger/v3-dev/automations_index_phase3.json',
