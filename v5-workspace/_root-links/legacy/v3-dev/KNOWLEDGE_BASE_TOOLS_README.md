...
```bash
# Save information
~/AutoTagger/v3-dev/save_knowledge.sh save "My Title" "Content goes here..." "category" "tag1" "tag2"

# Search for information
~/AutoTagger/v3-dev/save_knowledge.sh search "query" "optional_category"
```
...
```bash
# Save information
python3 ~/AutoTagger/v3-dev/capture_conversation.py --title "Title" --content "Content here" --category "category" --tags "tag1" "tag2"

# Search information
python3 ~/AutoTagger/v3-dev/capture_conversation.py --action search --query "search term"
```
...
The knowledge base is stored in: `~/AutoTagger/v3-dev/knowledge_base.db`
