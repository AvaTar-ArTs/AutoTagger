...
```bash
# Basic usage
python3 ~/AutoTagger/v3-dev/universal_directory_indexer.py <directory>

# With custom prefix
python3 ~/AutoTagger/v3-dev/universal_directory_indexer.py <directory> <prefix>

# Examples
python3 ~/AutoTagger/v3-dev/universal_directory_indexer.py ~/Pictures pictures_scan
python3 ~/AutoTagger/v3-dev/universal_directory_indexer.py ~/Documents docs_scan
python3 ~/AutoTagger/v3-dev/universal_directory_indexer.py ~/AVATARARTS/Automations automations_scan
```
